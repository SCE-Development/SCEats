...
const CashModal = ({ totalAmount, onClose, onComplete }: CashModalProps) => {
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[999] flex items-center justify-center">
      ...
      >
        ...
        <div className="relative mb-8">
          <h2 className="text-3xl font-bold text-center bg-gradient-to-r from-white to-sky-200 bg-clip-text text-transparent">Cash Payment</h2>
        </div>
        ...
        <div className="relative flex flex-col items-center space-y-8">
          ...
          {/* Instructions */}
          <div className="bg-sky-900/30 p-6 rounded-2xl border border-sky-500/30 w-full">
            <h3 className="text-xl font-semibold text-white/90 mb-4">Payment Instructions:</h3>
            <ol className="space-y-3 text-white/70">
              <li className="flex items-start">
                ...
                <span>Open the cabinet above the register</span>
              </li>
              <li className="flex items-start">
                ...
                <span>Place your cash in the metal box</span>
              </li>
              <li className="flex items-start">
                ...
                <span>Click "Done" below once payment is complete</span>
              </li>
            </ol>
          </div>
        </div>
